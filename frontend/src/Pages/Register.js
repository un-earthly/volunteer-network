...
export default function Register() {
  ...
  return (
    ...
    <div className='flex bg-gray-300 flex-col md:flex-row'>
      <Sidebar />
      <div className="bg-[#E5E5E5] flex items-center justify-center flex-col pb-10 flex-grow">
        <div className="pt-10 mt-14 bg-white border-2 border-[#ABABAB] flex items-center justify-center flex-col md:w-1/2 rounded-lg">
